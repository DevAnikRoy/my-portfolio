...
const experiences = [
  {
    title: 'Full-Stack and Webflow Developer',
    company: 'Softvence',
    location: 'Ambon Complex, Mohakhali, Dhaka',
    period: 'January 2025 – Present',
    type: 'Full-time',
    responsibilities: [
      'Specialized Full-Stack and Webflow Developer focused on building high-performance, visually engaging digital experiences.',
      'Engineered 40+ custom Webflow websites using advanced CMS structures, interactions, and custom code integrations.',
      'Applied a strong frontend foundation in HTML, CSS, and JavaScript to tailor complex UI components.',
      'Used backend knowledge across databases, APIs, and server-side logic to enable third-party integrations, dynamic data handling, and robust web applications.',
    ],
    technologies: [
      'Webflow',
      'CMS',
  ...
  },
  {
    ...
    type: 'Contract',
    responsibilities: [
      'Collaborated as a Contract Frontend Developer, contributing to the development and frontend architecture of core digital platforms.',
      'Translated complex design systems into clean, high-performing, and responsive web components using HTML, CSS, JavaScript, and Webflow.',
      'Focused on optimizing site speed, cross-device compatibility, and smooth interactive UI elements.',
      'Worked to ensure a premium user experience for a global brand.',
    ],
    technologies: [
      'HTML',
      'CSS',
